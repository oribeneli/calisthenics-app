...
export default function WhyPage() {
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-xl font-semibold">Why this program</h1>

      <Card className="flex flex-col gap-4 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
        <p>
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">Why full-body, three times a week.</strong>{' '}
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">Why one set first.</strong> The prescription for
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">Why never to failure.</strong> Pushing a set to
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">Why the push ladder starts with scapular
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">Why wrists go on fists.</strong> Pressing
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">Why no streaks, and only a 7-day weight
          average.</strong> A missed day does not undo a habit that is forming — but a streak counter resetting
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">The six habits.</strong> Protein at every meal,
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">What to expect in 8 weeks.</strong> Reps
        ...
        <p>
          <strong className="text-slate-900 dark:text-slate-100">Honest limits.</strong> Without a bar, rings,
        ...
        <p className="text-slate-500 dark:text-slate-500">
          ...
          <code className="rounded bg-slate-100 px-1 py-0.5 text-xs dark:bg-slate-800">docs/RESEARCH.md</code>.
        </p>
      </Card>
    </div>
  )
